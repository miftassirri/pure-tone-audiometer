...
def config():
    ...
    parser.add_argument("--earsides", type=str, nargs='+',
                        ...
                        "left or right")
    parser.add_argument("--right-ear", type=str, nargs='+',
                        default=['right'], help="The first list item "
                        "represents the beginning earside. The second list "
                        "item represents the ending earside, consequently. "
                        "It is also possible to choose only one earside, "
                        "left or right")
    parser.add_argument("--left-ear", type=str, nargs='+',
                        default=['left'], help="The first list item "
                        "represents the beginning earside. The second list "
                        "item represents the ending earside, consequently. "
                        "It is also possible to choose only one earside, "
                        "left or right")
    ...
    frekuensi = [1000, 1500, 2000, 3000, 4000, 6000, 8000, 750, 500, 250, 125]
    random.shuffle(frekuensi)

    parser.add_argument("--freqs", type=float, nargs='+', default=frekuensi,
                        help='The size '
    ...
    parser.add_argument("--cal125", default=[125, -85, 0])
    parser.add_argument("--cal250", default=[250, -95, 0])
    parser.add_argument("--cal500", default=[500, -95, 0])
    parser.add_argument("--cal750", default=[750, -105, 0])
    parser.add_argument("--cal1000", default=[1000, -100, 0])
    parser.add_argument("--cal1500", default=[1500, -115, 0])
    parser.add_argument("--cal2000", default=[2000, -110, 0])
    parser.add_argument("--cal3000", default=[3000, -110, 0])
    parser.add_argument("--cal4000", default=[4000, -110, 0])
    parser.add_argument("--cal6000", default=[6000, -100, 0])
    parser.add_argument("--cal8000", default=[8000, -90, 0])
